        ...
        <div className="w-full max-w-md mx-auto space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Product List</span>
            </button>
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Update Details</span>
            </button>
          </div>
        </div>
      </main>
