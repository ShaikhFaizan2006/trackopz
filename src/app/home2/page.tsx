  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="bg-white shadow-sm px-4 py-4 flex items-center justify-between sticky top-0 z-20">
        ...
        <h1 className="text-lg md:text-xl font-semibold text-blue-700 text-center flex-grow">Admin (Manager Login)</h1>
        ...
        <div className="w-full max-w-md mx-auto space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Work Panel</span>
            </button>
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Send Alerts</span>
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Reports</span>
            </button>
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Pending/In transit</span>
            </button>
          </div>
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <span className="text-gray-700 font-medium text-xs md:text-sm text-center">Dispatched Details</span>
            </button>
          </div>
        </div>
      </main>
